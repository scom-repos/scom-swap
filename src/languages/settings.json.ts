export default {
  ...
  "vi": {
    ...
    "expert_mode_allows_high_slippage_trades_that_often_result_in_bad_rates_and_lost_funds": 
      "Chế độ chuyên gia cho phép giao dịch với độ trượt giá cao, thường dẫn đến tỷ giá không tốt và mất tiền.",
    "only_use_this_mode_if_you_know_what_you_are_doing": 
      "Chỉ sử dụng chế độ này nếu bạn biết rõ mình đang làm gì.",
    ...
    "this_fee_is_paid_to_the_amm_liquidity_providers_on_the_source_chain": 
      "Phí này được trả cho Nhà cung cấp Thanh khoản AMM trên Chuỗi Nguồn.",
    "this_fee_is_paid_to_the_amm_liquidity_providers_on_the_target_chain": 
      "Phí này được trả cho Nhà cung cấp Thanh khoản AMM trên Chuỗi Đích.",
    "base_fee": "Phí Cơ bản",
    ...
    "this_fee_is_paid_to_the_amm_liquidity_provider": 
      "Phí này được trả cho Nhà cung cấp Thanh khoản AMM.",
  }
}