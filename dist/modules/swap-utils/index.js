...
define("@swap/swap-utils", ["require", "exports", "@ijstech/eth-wallet", "@openswap/sdk", "@swap/global", "@swap/crosschain-utils", "@swap/store", "@swap/swap-utils/helper.ts"], function (require, exports, eth_wallet_1, sdk_1, global_1, crosschain_utils_2, store_2, helper_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const getFactoryAddress = (key) => {
        ...
        return ((_a = providers.find(item => item.key === key)) === null || _a === void 0 ? void 0 : _a.factoryAddress) || '';
    };
    function getRouterAddress(key) {
        ...
        // }
        const providers = store_2.getProviderList();
        return ((_a = providers.find(item => item.key === key)) === null || _a === void 0 ? void 0 : _a.routerAddress) || '';
    }
    ...
    async function getBestAmountInRouteFromAPI(wallet, tokenIn, tokenOut, amountOut, chainId) {
        ...
        store_2.getProviderList().filter(v => !!v.supportedChains && v.supportedChains.includes(chainId)).forEach((v, i) => {
        ...
        if (firstTokenObject && secondTokenObject && (firstInput.gt(0) || secondInput.gt(0))) {
            ...
            if (isFromEstimated) {
                ...
                if (routeDataArr.length == 0) {
                    ...
                    if (routeObj && routeObj.market.length == 1) {
                        let providerConfigByKey = {};
                        let _chainId = store_2.getChainId();
                        store_2.getProviderList().filter(v => !!v.supportedChains && v.supportedChains.includes(_chainId)).forEach((v, i) => {
                            providerConfigByKey[v.key] = v;
                        });
                ...
                if (routeDataArr.length == 0) {
                    const providerKey = (_b = store_2.getProviderList()[0]) === null || _b === void 0 ? void 0 : _b.key;
                    ...
                    if (routeObj && routeObj.market.length == 1) {
                        ...
                        let priceImpact = Number(routeObj.priceImpact) * 100;
                        let tradeFee = parseFloat(routeObj.tradeFee);
                        let provider = (_c = providerConfigByMarketCode[routeObj.market[0]]) === null || _c === void 0 ? void 0 : _c.key;
                        let key = provider + '|0';
                        routeDataArr.push(Object.assign(Object.assign({}, routeObj), { price,
                            priceSwap,
                            priceImpact,
            ...
            if (routeDataArr && routeDataArr.length > 0) {
                for (let i = 0; i < routeDataArr.length; i++) {
                    ...
                    const provider = ((_d = store_2.getProviderList().find(item => item.key === optionObj.provider)) === null || _d === void 0 ? void 0 : _d.key) || '';
