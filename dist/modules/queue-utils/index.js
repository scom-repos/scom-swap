define("@swap/queue-utils", ["require", "exports", "@swap/global", "@ijstech/eth-wallet", "@swap/store", "@scom/oswap-openswap-contract", "@scom/oswap-chainlink-contract", "@scom/oswap-oracle-adaptor-contract", "@ijstech/components"], function (require, exports, global_1, eth_wallet_1, store_1, oswap_openswap_contract_1, oswap_chainlink_contract_1, oswap_oracle_adaptor_contract_1, components_1) {
    "use strict";
    ...
    const getTokenObjectByAddress = (address) => {
        ...
        let tokenMap = store_1.tokenStore.tokenMap;
    ...
    const getGroupQueueAllocation = async (traderAddress, offerIndex, pairAddress, tokenIn, tokenOut) => {
        ...
        return await new oswap_openswap_contract_1.Contracts.OSWAP_RestrictedPair(eth_wallet_1.Wallet.getClientInstance(), pairAddress).traderAllocation({ param1: direction, param2: offerIndex, param3: traderAddress });
    };
