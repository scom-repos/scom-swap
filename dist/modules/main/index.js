...
define("@swap/main", ["require", "exports", "@ijstech/components", "@ijstech/eth-wallet", "@swap/assets", "@swap/store", "@swap/swap-utils", "@swap/global", "@swap/crosschain-utils", "@swap/price-info", "@swap/result", "@ijstech/eth-contract", "@swap/main/index.css.ts"], function (require, exports, components_2, eth_wallet_1, assets_2, store_1, swap_utils_1, global_1, crosschain_utils_1, price_info_1, result_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    let SwapBlock = class SwapBlock extends components_2.Module {
        constructor(parent, options) {
            ...
            this.redirectToken = () => {
                ...
                if (!window.location.hash.includes('#/swap'))
                    return;
            ...
            this.onSetupPage = async (connected) => {
                ...
                if (this.chainId === 56 && ((_a = this.desChain) === null || _a === void 0 ? void 0 : _a.chainId) === 43114 || this.chainId === 43114 && ((_b = this.desChain) === null || _b === void 0 ? void 0 : _b.chainId) === 56) {
            ...
            this.setDefaultToken = () => {
                var _a;
                let lstTokenMap = Object.values(store_1.getTokenMap());
            ...
            this.onSetting = () => {
                this.$eventBus.dispatch("ShowTransactionModal" /* ShowTransactionModal */);
            };
        ...
        get targetTokenMap() {
            return this.isCrossChain ? this.targetChainTokenMap : store_1.getTokenMap();
        }
        ;
        initTokenSelection() {
        ...
        async onSelectToken(token, isFrom) {
            ...
            if (token.isNew && store_1.isWalletConnected()) {
                await store_1.updateAllTokenBalances();
                this.allTokenBalancesMap = store_1.getTokenBalances();
            }
      ...
      class="inline-block" fallbackUrl="${this.fallbackUrl}"></i-image>`;
        ...
        async updateBalance() {
            ...
            if (store_1.isWalletConnected())
                await store_1.updateAllTokenBalances();
            this.allTokenBalancesMap = store_1.isWalletConnected() ? store_1.getTokenBalances() : [];
            if (this.fromToken) {
                const balance = this.getBalance(this.fromToken);
                                    ...
                                    this.$render("i-panel", { class: "bg-box", width: "100%" },
                                        this.$render("i-hstack", { class: "input--token-box", verticalAlignment: "center", horizontalAlignment: "space-between", width: "100%" },
                                            this.$render("i-vstack", null,
                                                this.$render("swap-token-selection", { id: "firstTokenSelection" })),
                            ...
                            this.$render("i-panel", { class: "token-box" },
                                this.$render("i-vstack", { id: "receiveContainer", class: "input--token-container" },
                                    this.$render("i-vstack", { class: "balance-info", width: "100%" },
                                        ...
                                        this.$render("i-vstack", { id: "desChainBox", class: "my-2 w-100" },
                                            this.$render("i-hstack", { verticalAlignment: "center", horizontalAlignment: "space-between" },
                                    ...
                                    this.$render("i-panel", { class: "bg-box", width: "100%" },
                                        this.$render("i-hstack", { class: "input--token-box", verticalAlignment: "center", horizontalAlignment: "space-between", width: "100%" },
                                            this.$render("i-vstack", null,
                                                this.$render("swap-token-selection", { id: "secondTokenSelection" })),
